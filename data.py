...
class PascalDataset(data.Dataset):
    ...
    def __getitem__(self, i):
        ...
        return transform(image, boxes, labels, difficults, split=self.split) # converts all but difficults to tensors 
    ...
    def collate_fn(self, batch):
        ...
        for b in batch:
            all_images.extend(b[0])
            all_boxes.extend(b[1])
            all_labels.extend(b[2])
            all_difficults.extend(b[3])
